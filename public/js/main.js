    ...
    jQuery(document).ready(function(){
        ...
        */
        ...
        $('.ltn__shop-details-small-img').slick({
            ...
            arrows: true,
            focusOnSelect: true,
            prevArrow: '<a class="slick-prev"><i class="fas fa-thin fa-chevron-left" alt="Arrow Icon"></i></a>',
            nextArrow: '<a class="slick-next"><i class="fa-thin fa-chevron-right" alt="Arrow Icon"></i></a>',
            responsive: [
                {
                    breakpoint: 992,
                    settings: {
        ...
        $('.ltn__slide-one-active').slick({
            ...
            slidesToScroll: 1,
            prevArrow: '<a class="slick-prev"><i class="fas fa-thin fa-chevron-left" alt="Arrow Icon"></i></a>',
            nextArrow: '<a class="slick-next"><i class="fas ffa-thin fa-chevron-right" alt="Arrow Icon"></i></a>',
            responsive: [
                {
                    breakpoint: 1200,
                    settings: {
        ...
        */
        ...
        ltn__testimonial_quote_slider.slick({
            ...
            slidesToScroll: 1,
            prevArrow: '<a class="slick-prev"><i class=" fas fa-thin fa-chevron-left" alt="Arrow Icon"></i></a>',
            nextArrow: '<a class="slick-next"><i class="fas fa-thin fa-chevron-right" alt="Arrow Icon"></i></a>',
            responsive: [
                {
                    breakpoint: 992,
                    settings: {
